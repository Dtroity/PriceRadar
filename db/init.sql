...
CREATE INDEX IF NOT EXISTS idx_products_normalized_name ON products(organization_id, normalized_name);
CREATE INDEX IF NOT EXISTS idx_products_is_priority ON products(organization_id, is_priority);
...
CREATE INDEX IF NOT EXISTS idx_product_mapping_org_supplier ON product_mapping(organization_id, supplier_id);
...
CREATE INDEX IF NOT EXISTS idx_product_aliases_organization ON product_aliases(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_price_lists_organization ON price_lists(organization_id);
CREATE INDEX IF NOT EXISTS idx_price_lists_supplier ON price_lists(supplier_id);
CREATE INDEX IF NOT EXISTS idx_price_lists_upload_date ON price_lists(upload_date);
...
CREATE INDEX IF NOT EXISTS idx_prices_price_list ON prices(price_list_id);
...
CREATE INDEX IF NOT EXISTS idx_price_changes_organization ON price_changes(organization_id);
CREATE INDEX IF NOT EXISTS idx_price_changes_created ON price_changes(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_price_changes_supplier ON price_changes(supplier_id);
CREATE INDEX IF NOT EXISTS idx_price_changes_priority ON price_changes(is_priority);
...
CREATE INDEX IF NOT EXISTS idx_price_forecasts_organization ON price_forecasts(organization_id);
CREATE INDEX IF NOT EXISTS idx_price_forecasts_product ON price_forecasts(product_id);
...
CREATE INDEX IF NOT EXISTS idx_telegram_users_organization ON telegram_users(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_ai_feedback_organization ON ai_feedback(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_iiko_products_mapping_org ON iiko_products_mapping(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_food_cost_history_menu_item ON food_cost_history(menu_item_id);
...
CREATE INDEX IF NOT EXISTS idx_foodcost_alerts_menu_item ON foodcost_alerts(menu_item_id);
...
CREATE INDEX IF NOT EXISTS idx_supplier_prices_history_org ON supplier_prices_history(organization_id);
CREATE INDEX IF NOT EXISTS idx_supplier_prices_history_supplier_product ON supplier_prices_history(supplier_id, product_id);
...
CREATE INDEX IF NOT EXISTS idx_supplier_score_organization ON supplier_score(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_processing_errors_document ON processing_errors(document_id);
...
-- Optional seed: demo organization + org_admin user
DO $$
DECLARE
  org_id uuid;
BEGIN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM users WHERE organization_id = org_id AND email = 'demo@demo.com'
  ) THEN
    INSERT INTO users (organization_id, email, password_hash, role)
    VALUES (
      org_id,
      'demo@demo.com',
      '$2a$10$gOOfPokdmvwX0QaPhyOczO0aPBKt2l2czxUZ0UW7y9StWieorSa/2',
      'org_admin'
    );
  END IF;
END $$;
...
-- Unified ingestion (classify → confirm → price list or document)
