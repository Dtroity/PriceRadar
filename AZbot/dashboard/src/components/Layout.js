...
const menuItems = [
  ...
  { text: 'Поставщики', icon: <SuppliersIcon />, path: '/suppliers' },
  { text: 'Фильтры', icon: <FiltersIcon />, path: '/filters' },
  { text: 'Статистика', icon: <StatsIcon />, path: '/stats' },
  { text: 'Активность', icon: <ActivityIcon />, path: '/activity' },
];
      ...
      >
        <Toolbar>
          ...
          >
            ...
            <MenuItem onClick={handleProfileMenuClose}>Настройки</MenuItem>
            <Divider />
